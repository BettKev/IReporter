...
def index():
    ...
    <td><span class="auth-required">âœ”ï¸ Org</span></td>
    </tr>
    <tr>
    ...
    <tr>
    <td><code>/intervension</code></td>
    <td>POST</td>
    <td>Creates a new Intervension.</td>
    <td><span class="auth-required">âœ”ï¸ Org</span></td>
    </tr>
    <tr>
    <td><code>/intervensions</code></td>
    <td>GET</td>
    <td>Fetches all Intervensions. (As Admin)</td>
    <td><span class="auth-required">âœ”ï¸ JWT</span></td>
    </tr>
    <tr>
