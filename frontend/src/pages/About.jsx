    ...
    return (
      <section className="bg-gray-800 text-white min-h-screen flex items-center justify-center mt-16 rounded-3xl">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          {/* The Team Section */}
          <div className="mt-16">
            <h2 className="text-3xl font-semibold text-center text-yellow-300">The Team</h2>
            <div className="grid gap-8 mt-8 md:grid-cols-3">
              ...
              <div className="group bg-gray-800 rounded-lg p-6 shadow-lg transform transition-all hover:scale-105 hover:shadow-xl hover:bg-gray-200 hover:text-gray-900 flex items-center">
                <img
                  src="/path/to/profile1.jpg" // Replace with actual image paths
                  alt="Kevin Bett"
              ...
              <div className="group bg-gray-800 rounded-lg p-6 shadow-lg transform transition-all hover:scale-105 hover:shadow-xl hover:bg-gray-200 hover:text-gray-900 flex items-center">
                <img
                  src="/path/to/profile2.jpg" // Replace with actual image paths
              ...
              <div className="group bg-gray-800 rounded-lg p-6 shadow-lg transform transition-all hover:scale-105 hover:shadow-xl hover:bg-gray-200 hover:text-gray-900 flex items-center">
                <img
                  src="/public/myImage2.jpg" // Replace with actual image paths
                  alt="David Parsley"
                  className="w-16 h-16 rounded-full mr-4"
                />
                <div>
